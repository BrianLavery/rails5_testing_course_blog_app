...
RSpec.describe "Articles", type: :request do
  ...
  describe 'GET /articles/:id/edit' do
    ...
    context 'with signed in user who is non owner' do
      ...
      it "redirects to the home page" do
        expect(response.status).to eq 302
        # expect(page.current_path).to eq root_path # Controller Specs don't have access to Capybara helpers but feature specs do https://stackoverflow.com/questions/29448012/rspec-and-capybara-undefined-local-variable-or-method-page
